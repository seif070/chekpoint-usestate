const data=[
    {id:1,title: 'Blow', genre:'Action',checked:false,
    ...
    rate:7.8,sortie:2001,imageSrc:'https://m.media-amazon.com/images/I/51ABCZ3C8TL._AC_UF1000,1000_QL80_.jpg'},

    {id:2,title:'La Plateforme' ,genre:'Action',checked:false,
    ...
    rate:7.2,sortie:2020,imageSrc:'https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQJHg57lYxrDQj8mqKk52Ky0XjL8FlkwlV6uBeOaXvUEBEwISqD'},

    {id:3,title:'El Camino' ,genre:'Action',checked:false,
    ...
    rate:7.9,sortie:2023,imageSrc:'https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcTuEzZgS_3oHR0HtGuwtiKa-9-Qwc381LXHAxnaV0JHtURP07iv'},

    {id:4,title: 'Gladiator',genre:'Action',checked:false,
    ...
    rate:8.5,sortie:2000,imageSrc:'https://m.media-amazon.com/images/I/61MSIFHAxML._AC_UF894,1000_QL80_.jpg'},

    {id:5,title:'Man on Fire' ,genre:'Action',checked:false,
      ...
      rate:6.5,sortie:2009,imageSrc:'https://musicart.xboxlive.com/7/d50c1200-0000-0000-0000-000000000002/504/image.jpg?w=1920&h=1080'},

    {id:6,title:'Immortale' ,genre:'Action',checked:false,
    ...
    rate:7,sortie:2023,imageSrc:'https://fr.web.img4.acsta.net/pictures/21/12/01/11/55/3274106.jpg'},
  ];
export default data